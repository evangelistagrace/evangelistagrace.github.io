...
{% include image.html url="/assets/img/hello-jekyll/1.jpg" description="Blogger's classic theme editor. Classic indeed."%}
...
This blog is the outcome. The default theme was [Minima](https://github.com/jekyll/minima). I forked the [Lagrange](https://lenpaul.github.io/Lagrange/) theme and tweaked the styles to make the theme look close to the [Libretto](https://wordpress.org/themes/libretto/) theme. The Lagrange theme was especially handy as it came with DISQUS and Google Analytics plugin. Overall, I am pleased with my new blog as I have control over the content, formatting, styling and hosting. I am excited to write more quality content in the future!
