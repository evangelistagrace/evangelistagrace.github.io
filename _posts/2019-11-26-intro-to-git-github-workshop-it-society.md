...
{% include image.html url="/assets/img/github-workshop/3.JPG" description="The scribblings on the whiteboard tho"%}

{% include image.html url="/assets/img/github-workshop/4.JPG" description="Say cheese!" %}

{% include image.html url="/assets/img/dividers/1.png" width="200px"%}
